...
mod tests {
    ...
    fn test_direct_connect_string_has_no_cid() {
        ...
        // shape — no CID block, PROTOCOL follows tls_mode.
        let config = Config::new("myhost", 1522, "myservice", "user", "pass");
        let connect_str = config.build_connect_string();
    ...
    fn test_proxy_inject_connect_string_has_cid() {
        ...
        let mut config = Config::new("myhost", 1522, "myservice", "scott", "pass");
    ...
    fn test_proxy_inject_sanitizes_username_in_cid() {
        ...
        let mut config = Config::new("myhost", 1522, "myservice", "od)d=(user", "pass");
        config.proxy_inject = true;
        let connect_str = config.build_connect_string();
